...
> Layered docs: scope + tradeoffs trong [`AI_PROMPTS.md`](AI_PROMPTS.md), source-board workflow trong
> [`PLAYER_FULL_ASSET_SOURCE_PROMPT.md`](PLAYER_FULL_ASSET_SOURCE_PROMPT.md), animation math trong
...
4. Nếu muốn consistency cao hơn, gen 1 source board trước bằng [`PLAYER_FULL_ASSET_SOURCE_PROMPT.md`](PLAYER_FULL_ASSET_SOURCE_PROMPT.md).
