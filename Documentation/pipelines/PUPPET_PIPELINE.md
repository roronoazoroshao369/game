...
audience: both
status: active — default pipeline
scope: 2D procedural puppet rig (DST-style). 30 PNG part → demo runs. Default cho mọi character + mob.
depends-on:
  - DST_RIG_ASSET_GUIDE.md
  - ../art/ART_STYLE.md
---
...
> Layered docs: scope + tradeoffs trong [`AI_PROMPTS.md`](../art/AI_PROMPTS.md), source-board workflow trong
> [`PLAYER_FULL_ASSET_SOURCE_PROMPT.md`](../art/PLAYER_FULL_ASSET_SOURCE_PROMPT.md), animation math trong
> `Scripts/Vfx/PuppetAnimController.cs` xml-doc, và asset-side practical rules trong
...
4. Nếu muốn consistency cao hơn, gen 1 source board trước bằng [`PLAYER_FULL_ASSET_SOURCE_PROMPT.md`](../art/PLAYER_FULL_ASSET_SOURCE_PROMPT.md).
5. Nếu art nhìn rời rạc / paper-doll → đọc [`DST_RIG_ASSET_GUIDE.md`](DST_RIG_ASSET_GUIDE.md) trước khi regen.
