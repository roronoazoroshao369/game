...
- **E** → tương tác (lửa trại, suối nước, **mở rương** — bấm slot trong panel để chuyển item player ↔ chest, ESC để đóng; **Workbench** — sửa món durable đầu tiên trong inventory, tốn 1 cành cây / lần)
- **T** → bật/tắt đuốc
